    ...
    protected override Task OnStart(IMessageSession session, CancellationToken cancellationToken)
    {
        ...
        timer.Start(
            ...
            errorCallback: exception =>
            {
                ...
                {
                    criticalError("Failed to clean expired Outbox records after 10 consecutive unsuccessful attempts. The most likely cause of this is connectivity issues with the database.", exception, CancellationToken.None);
                    cleanupFailures = 0;
                }
            },
