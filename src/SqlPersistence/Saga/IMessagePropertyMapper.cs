namespace NServiceBus.Persistence.Sql
{
    ...
    /// </summary>
    [ObsoleteEx(
        Message = "The SqlSaga base class is deprecated. Use 'NServiceBus.Saga<T>' with the 'mapper.MapSaga(…).ToMessage(…)' API. Other SqlSaga features can be added by applying the 'SqlSagaAttribute' to the saga class",
        RemoveInVersion = "10",
