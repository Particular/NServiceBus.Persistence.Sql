namespace NServiceBus.PersistenceTesting.Sagas
{
    ...
    public class When_persisting_a_saga_with_an_escalated_DTC_transaction : SagaPersisterTests
    {
        ...
        public async Task Should_rollback_dtc_transaction_when_storage_session_rolls_back()
        {
            ...
            await Task.WhenAny(enlistmentNotifier.CompletionSource.Task, Task.Delay(TimeSpan.FromSeconds(30)));
        ...
        class EnlistmentNotifier : IEnlistmentNotification
        {
            readonly bool abortTransaction;

            public EnlistmentNotifier(bool abortTransaction)
            {
